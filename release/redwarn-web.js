...
var rw = {
    ...
    /**
     * This varible is defined by the magic word "Build Time: 07/05/2021 15:07:26UTC
...
User: zng@DESKTOP-SOGE7SE on Linux", which the build script will replace with information
    ...
    "buildInfo": `Build Time: 07/05/2021 15:07:26UTC
Excecuted script: /home/zng/redwarn-web/build.php
    ...
    */
    ...
    "sendEmail": (user, content) => {
        ...
        var params = {
            action: 'emailuser',
            target: user,
            subject: `Email from User:${rw.info.getUsername()} (using RW)`, // i.e. email from User:Ed6767 (using RW)
            text: content,
