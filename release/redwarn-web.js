...
var rw = {
    ...
    /**
     * This varible is defined by the magic word "Build Time: 07/03/2021 17:45:43UTC
Excecuted script: /Users/ed/redwarn-web/build.php
User: ed@Eds-Mac-Pro.local on Darwin", which the build script will replace with information
    ...
    "buildInfo" : `Build Time: 07/03/2021 17:45:43UTC
Excecuted script: /Users/ed/redwarn-web/build.php
User: ed@Eds-Mac-Pro.local on Darwin`,
...
<b>Important:</b> Please be aware that this can take a while to process on longer pages with larger changes, so if the progress bar freezes, please be paitent as RedWarn is still processing in the background.
    ...
    "openPreferences": () => { // Open Preferences page
        ...
        dialogEngine.create(mdlContainers.generateContainer(eval(rw_includes["preferences.html"]), window.innerWidth, window.innerWidth, true), true).showModal(); // TRUE HERE MEANS NO PADDING.
    },
