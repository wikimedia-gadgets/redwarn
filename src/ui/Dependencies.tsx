...
export default class Dependencies {
    ...
    static async resolve() : Promise<void> {
        ...
        const headElements = [
            ...
            ...Dependencies.buildDependencyElements(StyleManager.activeStyle.dependencies)
        ];
    ...
    static buildDependency(dependency : Dependency) : HTMLElement & {promise: Promise<boolean>} {
    ...
    static buildDependencyElements(depsList : Dependency[]) : (HTMLElement & {promise: Promise<boolean>})[] {
        ...
        for (const dependency of depsList) {
            console.log(`Loading ${dependency.type} dependency: ${dependency.src}`)
